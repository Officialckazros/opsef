"""Async OpenAI-compatible LLM client used by SefBot's modular AI features.
...
generic ``SEFBOT_LLM_BASE_URL`` / ``SEFBOT_LLM_API_KEY`` env vars — point those
...
class LLMClient:
    ...
    async def get_image(
        ...
        headers = {"User-Agent": "Mozilla/5.0 (compatible; SefBot/1.0)"}
